...
\begin{homeworkProblem}
    ...
    Since the x-variants $s_1',s_2'$ agree on any specific variable assignment we can apply the IH, deriving $\mathfrak{M},s_2'\models\psi$ from $\mathfrak{M},s_1'\models\psi$. \\
